        ...
        <div className='flex justify-between'>
            ...
            <div className='hidden  md:flex flex-col md:w-1/5 border-4 min-h-96 rounded-r-full bg-gradient-to-r from-yellow-500 via-yellow-400 to-yellow-300'>
                ...
                <div className='flex flex-col md:w-3/4'>
                    <div className='md:bg-transparent bg-gray-50 rounded-full '>
                    <h1 className='font-semibold text-xl text-center md:ml-0 md:mr-24'>Add/Create/Edit Events</h1>
                    <h4 className='text-slate-400 text-md text-center md:ml-0  md:mr-24 '>Add meeting duration and week days available for the meeting </h4>
                    </div>
