    ...
    <div className="mt-32 ">
      ...
      <div className="flex md:flex-row flex-col justify-center items-center mt-16">
        ...
        <motion.div initial={{ opacity: 0, y: 100, scale: 0.5 }}
          ...
          <h2 className="text-3xl font-semibold mb-4 text-center">Free</h2>
          
          <div className="text-3xl mt-8 font-bold text-center mb-4">$0</div>
          <div className="flex flex-col items-center">
            <ul className=" flex text-center flex-col mb-4">
              <li>Share and book any meeting .</li>
              <li>Free Meeting platform for live video conferencing .</li>
              <li>Reminder Emails for every meetings </li>
            </ul>
        ...
        <motion.div
          ...
          <h2 className="text-3xl font-semibold mb-4 text-center">Basic</h2>
        ...
        <motion.div
          ...
          className="md:w-1/5 w-52 h-96 md:mt-0 mt-8 md:mx-4 rounded-lg overflow-hidden shadow-lg p-6 bg-slate-100">
          <h2 className="text-3xl font-semibold mb-4 text-center">Unlimitted</h2>
